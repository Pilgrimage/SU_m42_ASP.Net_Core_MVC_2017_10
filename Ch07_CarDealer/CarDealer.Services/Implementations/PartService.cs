namespace CarDealer.Services.Implementations
{
    ...
    public class PartService : IPartService
    {
        ...
        public IEnumerable<PartListingServiceModel> All(int page = 1, int pageSize = 25)
        {
            page = page < 1 ? 1 : page;
        ...
        public IEnumerable<PartSelectServiceModel> PartSelect()
        {
            return this.db
                .Parts
                .OrderBy(p => p.Id)
                .Select(p => new PartSelectServiceModel
                {
                    Id = p.Id,
                    Name = p.Name
                })
